...
class Training extends Model
{
    ...
    public $hasMany = [
        'videos' => [
            \Pensoft\TrainingCorner\Models\Videos::class,
            'order' => 'sort_order asc'
        ],
        'documents' => [
            \Pensoft\TrainingCorner\Models\Documents::class,
            'order' => 'sort_order asc'
        ],
        'modules' => [
            \Pensoft\TrainingCorner\Models\Modules::class,
            'order' => 'sort_order asc'
        ]
    ];
    public $belongsTo = [];
    ...
    public $morphMany = [];
    public $attachOne = [
        'cover_image' => \System\Models\File::class
    ];
    public $attachMany = [
        'carousel_images' => \System\Models\File::class
    ];
